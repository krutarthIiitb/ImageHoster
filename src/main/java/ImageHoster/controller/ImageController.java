...
public class ImageController {
    ...
    public String showImage(@PathVariable("id") Integer id, Model model) {
        ...
        model.addAttribute("comments",commentsService.getAllCommentsByImage(id));
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if (user == null || (user != null && !user.getId().equals(image.getUser().getId()))) {
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags,Model model, Image updatedImage, HttpSession session) throws IOException {
